...
## 🛠️ Decisões de Projeto e Justificativas
...
3. No menu superior, vá em **Ferramentas > Opções do Compilador**.
4. Marque a caixa "Adicionar os seguintes comandos" e digite: `-std=c99`
5. Pressione `F11` para compilar e executar.

### Opção 2: Usando o Terminal (Linux / Mac / Prompt de Comando)
Se você possui o compilador GCC instalado, abra o terminal na pasta onde os três arquivos estão salvos e digite o comando de compilação interligando os arquivos `.c`:

```bash
gcc main.c contatos.c -o gerenciador